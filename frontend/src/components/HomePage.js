				...
				<Box sx={{
					...
					<Container maxWidth="md" sx={{ zIndex: 2, py: { xs: 6, md: 10 } }}>
						...
						<Paper elevation={3} sx={{
								...
								<Select
									...
									renderValue={(selected) => selected ? (
										<Box sx={{ display: 'flex', alignItems: 'center', gap: 0.8 }}>
											<LocationOnIcon sx={{ fontSize: 20, color: '#e53935' }} />
											<span>{selected}</span>
										</Box>
									) : <span style={{ color: '#aaa' }}>Select city</span>}
									sx={{ fontSize: '1.1rem', background: '#fff', borderRadius: 2 }}
							...
							<FormControl size="medium" sx={{ flex: 1.2 }}>
								<Select
									displayEmpty
									...
									renderValue={(selected) => selected ? (
										<Box sx={{ display: 'flex', alignItems: 'center', gap: 0.8 }}>
											<SchoolIcon sx={{ fontSize: 20, color: '#e53935' }} />
											<span>{selected}</span>
										</Box>
									) : <span style={{ color: '#aaa' }}>Choose specialty</span>}
									sx={{ fontSize: '1.1rem', background: '#fff', borderRadius: 2 }}
									inputProps={{ style: { fontSize: '1.1rem', minHeight: 48 } }}
								>
